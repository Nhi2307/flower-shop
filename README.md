...
1. Clone repo về máy https://github.com/Nhi2307/flower-shop.git

2. Tạo database
- Mở SSMS, tạo database mới tên `Data-Shop-Flower`  
- Mở file `Data-Shop-Flower.sql` trong repo  
...
- Đảm bảo `Initial Catalog = Data-Shop-Flower`  
